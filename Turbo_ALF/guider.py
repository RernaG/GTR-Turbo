...
class MergedModelGuider():
    ...
    def generate_thought(self, obs, prompt_text, temperature=0.3):
        ...
        answer = self.tokenizer.decode(list(filter(lambda num: num != 0, output_ids[0].tolist())), skip_special_tokens=True, clean_up_tokenization_spaces=False)
    ...
    def thought_guide_sft(self, prompt_text, text_action, img):
        ...
        return torch.tensor(correct_tok).unsqueeze(0), labels, format_reward, valid, thought_token_length, correct_res
