...
class PPO():
    ...
    def update(self, rollouts, update_num, args):
        ...
        for e in range(self.ppo_epoch):
                ...
                with self.accelerator.accumulate(self.actor_critic):
                    ...
                    if args.tht_guide == 'SFT':
                        ...
                        value_preds_batch, return_batch, masks_batch, old_action_log_probs_batch, \
                                adv_targ, bc_obs_batch, input_ids_batch, labels_batch = sample
                        bc_obs_batch = bc_obs_batch.to(self.actor_critic.base.device)
            ...
            print(f"Save model checkpoint at PPO epoch {e}...")
            checkpoint_path = os.path.join(args.output_dir, args.tag, "update_" + str(update_num) + "_" + str(e))     
            os.makedirs(checkpoint_path, exist_ok=True)
            self.actor_critic.value_model.base.save_pretrained(checkpoint_path)
