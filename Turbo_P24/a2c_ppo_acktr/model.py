...
class VLMPolicy(nn.Module):
    ...
    def act(self, inputs, deterministic=False, PROMPT_TEXT=None):
        ...
        return value, input_ids, output_ids, action, action_log_prob, action_tokens_log_prob, legal_action, raw_output_ids

    def sft_forward(self, imgs, input_ids, labels=None):
