...
def get_prompt(env_name, action_only, infos = None):
    ...
    if env_name == 'gym_cards/NumberLine-v0':
        ...
        if not action_only:
            ...
            qs = qs + '  "thoughts": "First check whether the current formula is complete. If so, output \'=\'. Otherwise consider which number or operator should be appended to make it equal 12.",\n'
